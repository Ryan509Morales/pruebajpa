...
public class FrmManteProd extends JFrame {
	...
	void registrar() {
		...
		try {
			...
			System.out.print("No se pudo realizar");
		}
	...
	void listado() {
		...
		//sql = select * from tb_categorias
		//jpql = "select u from Tipo u"
		List<Producto> lstProductos = em.createQuery("select p from Producto c").getResultList();
		txtSalida.setText("");
		for (Producto p : lstProductos) {
			txtSalida.append(p.getId_prod() + "" + p.getDes_prod() + "" + p.getStk_prod() + "" + p.getIdcategoria() + "\n");
		}
